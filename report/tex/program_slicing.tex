...
early termination is ignored. For instance, look at the following program:
\begin{lstlisting}
a := 4;
do (true) -> skip
od;
...
have? Namely, all reaching definitions that are used at this command is added to the investigation
queue, and all parents of this command is added.
...
while (!queue.empty())
	...
	if (!isIncluded(currentStatement))
		investigateValues(queue, currentStatement)
