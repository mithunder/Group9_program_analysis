// $ANTLR 3.2 debian-4 GuardCommand.g 2010-10-16 19:57:12
...
public class GuardCommandLexer extends Lexer {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:506:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // GuardCommand.g:506:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // GuardCommand.g:506:14: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mLINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:510:5: ( ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* ( '\\r\\n' | '\\r' | '\\n' ) | ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* )
            int alt7=2;
            alt7 = dfa7.predict(input);
            switch (alt7) {
                case 1 :
                    // GuardCommand.g:510:9: ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* ( '\\r\\n' | '\\r' | '\\n' )
                    {
                    // GuardCommand.g:510:9: ( '//' | '#' )
                    int alt2=2;
    ...
    public final void mANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:516:2: ( ( '#@' ) IDENTIFIER '=' '\"' (~ ( '\"' ) )* '\"' )
            // GuardCommand.g:516:4: ( '#@' ) IDENTIFIER '=' '\"' (~ ( '\"' ) )* '\"'
            {
            // GuardCommand.g:516:4: ( '#@' )
            // GuardCommand.g:516:5: '#@'
            {
            match("#@"); 
    ...
    public final void mINTEGER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:519:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // GuardCommand.g:519:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // GuardCommand.g:519:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // GuardCommand.g:519:26: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // GuardCommand.g:519:35: ( '0' .. '9' )*
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            // GuardCommand.g:521:12: ( (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* ) )
            // GuardCommand.g:521:14: (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* )
            {
            // GuardCommand.g:521:14: (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* )
            // GuardCommand.g:521:15: b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )*
            {
            ...
            // GuardCommand.g:521:29: (count= (d= LETTER | e= '0' .. '9' ) )*
            loop12:
            do {
                int alt12=2;
            	...
            	case 1 :
            	    // GuardCommand.g:521:29: count= (d= LETTER | e= '0' .. '9' )
            	    {
            	    // GuardCommand.g:521:30: (d= LETTER | e= '0' .. '9' )
            	    int alt11=2;
            	    ...
            	    switch (alt11) {
            	        case 1 :
            	            // GuardCommand.g:521:31: d= LETTER
            	            {
    ...
    public final void mLETTER() throws RecognitionException {
        try {
            // GuardCommand.g:525:2: ( '$' | 'A' .. 'Z' | 'a' .. 'z' | '_' )
            // GuardCommand.g:
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:531:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
            // GuardCommand.g:531:8: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
            {
