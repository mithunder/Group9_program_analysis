// $ANTLR 3.2 debian-4 GuardCommand.g 2010-10-16 17:54:28
...
public class GuardCommandLexer extends Lexer {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:469:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // GuardCommand.g:469:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // GuardCommand.g:469:14: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mLINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:473:5: ( ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* ( '\\r\\n' | '\\r' | '\\n' ) | ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* )
            int alt7=2;
            alt7 = dfa7.predict(input);
            switch (alt7) {
                case 1 :
                    // GuardCommand.g:473:9: ( '//' | '#' ) (~ ( '\\n' | '\\r' ) )* ( '\\r\\n' | '\\r' | '\\n' )
                    {
                    // GuardCommand.g:473:9: ( '//' | '#' )
                    int alt2=2;
    ...
    public final void mANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:479:2: ( ( '#@' ) IDENTIFIER '=' '\"' (~ ( '\"' ) )* '\"' )
            // GuardCommand.g:479:4: ( '#@' ) IDENTIFIER '=' '\"' (~ ( '\"' ) )* '\"'
            {
            // GuardCommand.g:479:4: ( '#@' )
            // GuardCommand.g:479:5: '#@'
            {
            match("#@"); 
    ...
    public final void mINTEGER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:482:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // GuardCommand.g:482:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // GuardCommand.g:482:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // GuardCommand.g:482:26: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // GuardCommand.g:482:35: ( '0' .. '9' )*
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            // GuardCommand.g:484:12: ( (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* ) )
            // GuardCommand.g:484:14: (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* )
            {
            // GuardCommand.g:484:14: (b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )* )
            // GuardCommand.g:484:15: b= LETTER (count= (d= LETTER | e= '0' .. '9' ) )*
            {
            ...
            // GuardCommand.g:484:29: (count= (d= LETTER | e= '0' .. '9' ) )*
            loop12:
            do {
                int alt12=2;
            	...
            	case 1 :
            	    // GuardCommand.g:484:29: count= (d= LETTER | e= '0' .. '9' )
            	    {
            	    // GuardCommand.g:484:30: (d= LETTER | e= '0' .. '9' )
            	    int alt11=2;
            	    ...
            	    switch (alt11) {
            	        case 1 :
            	            // GuardCommand.g:484:31: d= LETTER
            	            {
    ...
    public final void mLETTER() throws RecognitionException {
        try {
            // GuardCommand.g:488:2: ( '$' | 'A' .. 'Z' | 'a' .. 'z' | '_' )
            // GuardCommand.g:
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // GuardCommand.g:494:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
            // GuardCommand.g:494:8: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
            {
